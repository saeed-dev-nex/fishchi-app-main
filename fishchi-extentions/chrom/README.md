...
- ✅ وارد کردن منابع با DOI از سایت‌های بین‌المللی
- ✅ تشخیص خودکار DOI در صفحات وب
...
### سایت‌های ایرانی (استخراج کامل)
- **SID.ir** - پایگاه اطلاعات علمی ایران
- **Civilica.com** - سیویلیکا
- **Noormags.ir** - نورمگز

### سایت‌های بین‌المللی (وارد کردن DOI)
...
- **JSTOR** - jstor.org
- و سایر سایت‌هایی که DOI ارائه می‌دهند
...
#### روش 1: استخراج از سایت‌های ایرانی

1. به یکی از سایت‌های ایرانی (SID، Civilica، Noormags) بروید
...
#### روش 2: وارد کردن منبع با DOI

##### روش 2.1: تشخیص خودکار DOI

1. به یکی از سایت‌های بین‌المللی بروید (مثل Nature، Springer، IEEE)
2. صفحه مقاله را باز کنید
3. اکستنشن به صورت خودکار DOI را تشخیص می‌دهد
4. روی دکمه "وارد کردن DOI" کلیک کنید
5. پروژه مورد نظر را انتخاب کنید (اختیاری)
6. منبع از Crossref API دریافت و ذخیره می‌شود

##### روش 2.2: وارد کردن دستی DOI

1. روی آیکون اکستنشن کلیک کنید
2. بخش "وارد کردن DOI" را انتخاب کنید
3. DOI مقاله را در کادر مخصوص وارد کنید
   - مثال: `10.1038/nature12373`
   - مثال: `10.1016/j.cell.2020.02.058`
4. پروژه مورد نظر را انتخاب کنید (اختیاری)
5. روی "وارد کردن DOI" کلیک کنید

### نکات مهم درباره DOI

- DOI (Digital Object Identifier) یک شناسه یکتا برای منابع علمی است
- اکستنشن از Crossref API برای دریافت اطلاعات استفاده می‌کند
- منابع وارد شده شامل عنوان، نویسندگان، سال انتشار، مجله و سایر اطلاعات هستند
- زبان منابع DOI به صورت خودکار انگلیسی تنظیم می‌شود
...
- **v1.2.0** - اضافه شدن قابلیت وارد کردن منابع با DOI از سایت‌های بین‌المللی
