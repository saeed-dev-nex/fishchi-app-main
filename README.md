...
Fishchi App یک پلتفرم جامع مدیریت پروژه و همکاری تیمی است که با استفاده از فناوری‌های مدرن وب توسعه یافته است. این پروژه شامل یک معماری Full-Stack با استفاده از React در سمت کلاینت و Node.js در سمت سرور می‌باشد.
...
- **TailwindCSS / Material-UI** - برای استایل‌دهی
...
- **Git** - کنترل نسخه
- **Docker** (آماده توسعه) - کانتینریزه کردن
